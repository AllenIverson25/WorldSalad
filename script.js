...
let myStory1 = On the second lap, <b>${name1}</b> saw <b>${name2}</b> pushing hard, their strides looking <b>${adjective2}</b>, but <b>${name1}</b> wasn’t backing down. They could hear the crowd yelling “<b>${exclamation}</b>!” as they rounded the turn. With a burst of energy, <b>${name1}</b> <b>${verb}</b> past a <b>${adjective3}</b> opponent, determined to take the lead.
